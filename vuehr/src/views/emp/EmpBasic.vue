        ...
        <div>
            ...
            <transition name="slide-fade">
                <div v-show="showAdvanceSearch"
                     style="border: 1px solid #409eff;border-radius: 5px;box-sizing: border-box;padding: 5px 0px;margin: 10px 0px;">
                    <el-row>
                        <el-col :span="5">
                            政治面貌：
                        ...
                        <el-col :span="4">
                            职位:
                            <el-select v-model="searchValue.posId" placeholder="民族" size="mini"
                                       style="width: 130px;">
                                <el-option
                        ...
                        <el-col :span="4">
                            职称:
                            <el-select v-model="searchValue.jobLevelId" placeholder="民族" size="mini"
                                       style="width: 130px;">
                                <el-option
                    ...
                    <el-row style="margin-top: 10px;">
                        <el-col :span="5">
                            ...
                            <el-popover
                                ...
                                <div slot="reference"
                                     style="width: 130px;display: inline-flex;font-size: 13px;border: 1px solid #dedede;height: 26px;border-radius: 5px;cursor: pointer;align-items: center;padding-left: 8px;box-sizing: border-box"
                        ...
                        <el-col :span="10">
                            ...
                            <el-date-picker
                                size="mini"
                                v-model="searchValue.beginDateFrom"
                        ...
                        <el-col :span="5" :offset="4">
                            ...
                            <el-button size="mini" type="primary" icon="el-icon-search" @click="initEmps('advance')">
                                搜索
                            </el-button>
                        </el-col>
                    </el-row>
    ...
    methods: {
        ...
        initEmps(type) {
            ...
            if (type && type == 'advance') {
                ...
                url += "?page=" + this.page + "&limit=" + this.size;
                ...
                if (this.searchValue.beginDateFrom) {
                    url += "&beginDateFrom=" + this.searchValue.beginDateFrom[0] + "&beginDateTo=" + this.searchValue.beginDateFrom[1];
                }
            } else {
                url += "?page=" + this.page + "&limit=" + this.size + "&name=" + this.keyword;
            }
